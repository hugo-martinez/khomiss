...
class ArduinosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arduino" do
    assert_difference('Arduino.count') do
      post arduinos_url, params: { arduino: { b1: @arduino.b1, b2: @arduino.b2, b3: @arduino.b3 } }
    end
  ...
  test "should update arduino" do
    patch arduino_url(@arduino), params: { arduino: { b1: @arduino.b1, b2: @arduino.b2, b3: @arduino.b3 } }
